 ...
 *
 */
public class JakeGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    /**
     ...
     */
    public JakeGLSurfaceView(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public JakeGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    static class LogWriter extends Writer {
        ...
        private void flushBuilder() {
            if (mBuilder.length() > 0) {
                Log.v("JakeGLSurfaceView", mBuilder.toString());
